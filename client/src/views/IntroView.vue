...
const navigateHome = () => {
    ...
    tl.to('.moon-composition', {
        scale: 3,
        opacity: 0,
        filter: 'blur(10px)',
        duration: 1.2,
        ease: "power2.inOut"
    }, "<0.2"); // slightly overlapped
...
<template>
    <div ref="containerRef" class="w-full flex-1 flex flex-col items-center justify-between py-10 text-center relative overflow-hidden">
        
        <!-- Center Content Area -->
        <div class="relative w-full flex-1 flex flex-col items-center justify-center mt-5">
            ...
            <div class="moon-composition relative z-10">
                ...
                <div class="relative w-40 h-40 flex items-center justify-center">
                    <!-- Background Image -->
                    <img src="@/assets/Intro/I_IconBG.png" alt="Moon Background" class="absolute inset-0 w-full h-full object-contain blur-sm" />
        ...
        <div class="relative z-30 mb-4 intro-btn">
            ...
            >
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="w-8 h-8 text-gray-300 group-hover:text-white group-hover:translate-x-1 transition-transform">
