...
<template>
  <div class="min-h-screen bg-black text-white p-6 font-sans">
    <h1 class="text-3xl font-bold mb-8 text-center tracking-widest">TEST CONTROL</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
      ...
      >
        ...
        <!-- Image -->
        <div class="w-24 h-24 rounded-full border-2 border-white/30 overflow-hidden bg-black/40">
            <img :src="getImageUrl(plant.img)" :alt="plant.zh" class="w-full h-full object-cover opacity-90" />
        </div>
